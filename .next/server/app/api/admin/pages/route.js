(()=>{var a={};a.id=670,a.ids=[670],a.modules={261:a=>{"use strict";a.exports=require("next/dist/shared/lib/router/utils/app-paths")},3295:a=>{"use strict";a.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},3569:(a,b,c)=>{"use strict";c.r(b),c.d(b,{handler:()=>M,patchFetch:()=>L,routeModule:()=>H,serverHooks:()=>K,workAsyncStorage:()=>I,workUnitAsyncStorage:()=>J});var d={};c.r(d),c.d(d,{POST:()=>G});var e=c(95736),f=c(9117),g=c(4044),h=c(39326),i=c(32324),j=c(261),k=c(54290),l=c(85328),m=c(38928),n=c(46595),o=c(3421),p=c(17679),q=c(41681),r=c(63446),s=c(86439),t=c(51356),u=c(10641),v=c(45711),w=c(67360),x=c(35552),y=c(75668),z=c(46288);let A={legalName:"THE TWIN TITANS LTD",rcNumber:"8177973",address:"Shop 1 and 2, Late Ganiyu Adegboyega Shopping Complex, Prinnacle Junction, Ijaye-Titun Rounder, Ogun State, Nigeria"},B="25 August 2026";function C(a,b,c,d){let e=(0,y.up)(b,d),f=(0,y.up)(c,d);return b<=0?`Delivery ${a} is currently free on every order.`:c<=0?`Delivery ${a} is charged at a flat ${e} per order.`:`Delivery ${a} is charged at a flat ${e} per order, and is free on orders of ${f} or more.`}function D(a){return[C("within Nigeria",a.shippingFlatMinor,a.freeShippingOverMinor,a.baseCurrency),C("to addresses outside Nigeria",a.intlShippingFlatMinor,a.intlFreeShippingOverMinor,a.baseCurrency),"Thresholds are calculated on the order value before delivery charges."].join(" ")}var E=c(74823);let F=v.Ik({apply:v.zM().optional(),handles:v.YO(v.Yj()).optional()});async function G(a){try{await (0,w.ZT)()}catch(a){if(a instanceof w.D_)return u.NextResponse.json({error:"Not signed in."},{status:401});throw a}let b=F.safeParse(await a.json().catch(()=>({}))??{});if(!b.success)return u.NextResponse.json({error:"Invalid request."},{status:400});let{apply:c=!1,handles:d}=b.data,e=await (0,E.r5)(),f=(function(a){let b=function(a){let b=[];return(A.legalName&&b.push(A.legalName),A.rcNumber&&b.push(`RC ${A.rcNumber}`),A.address&&b.push(A.address),0===b.length)?`${a.storeName} ("we", "us", "our")`:`${a.storeName}, operated by ${b.join(", ")} ("we", "us", "our")`}(a),c=function(a){let b=a.supportEmail||"support@twintitanemporium.com",c=[`by email at <a href="mailto:${b}">${b}</a>`];return a.supportPhone&&c.push(`by phone on ${a.supportPhone}`),c.join(", or ")}(a),d=a.storeName,e=a.baseCurrency,f=a.paypalCurrency,g={handle:"terms",title:"Terms of service",seoTitle:`Terms of service — ${d}`,seoDescription:`The terms on which ${d} sells and delivers goods, covering ordering, pricing, delivery, returns and liability.`,bodyHtml:`
<p><strong>Effective ${B}.</strong> These terms govern your use of this website and every order you place with ${b}. Please read them before ordering — by placing an order you accept them.</p>
...
<p>Prices are set in ${e} and include applicable Nigerian taxes unless stated otherwise. Delivery is charged separately and is shown to you before you pay.</p>
<p>Where the site displays a price in another currency, that display is a <strong>convenience conversion and is indicative only</strong>. It uses a periodically updated reference rate and is not the rate your bank or card issuer will apply. The amount actually charged is taken in ${e}, or in ${f} where you pay by PayPal, as shown at checkout. Any difference arising from your provider's exchange rate, cross-border fees or card charges is a matter between you and them.</p>
...
<h2>5. Delivery</h2>
<p>${D(a)} Our current dispatch and delivery windows are set out on our <a href="/pages/shipping">Shipping &amp; delivery</a> page.</p>
...
<p>If something has gone wrong, contact us ${c}. We aim to acknowledge complaints within two business days and to resolve them within 14 days.</p>
...
`.trim()},h={handle:"privacy",title:"Privacy policy",seoTitle:`Privacy policy — ${d}`,seoDescription:`How ${d} collects, uses, shares and protects your personal data, and the rights you have under the Nigeria Data Protection Act 2023.`,bodyHtml:`
<p><strong>Effective ${B}.</strong> This policy explains what we do with your personal data when you visit this site or place an order. ${b} is the <strong>data controller</strong> for that data under the Nigeria Data Protection Act 2023 (the "NDPA").</p>
<p>You can reach us about anything in this policy ${c}.</p>
...
`.trim()};return[g,{handle:"returns",title:"Returns & refunds",seoTitle:`Returns & refunds — ${d}`,seoDescription:`How to return an item to ${d}, what can and cannot be returned, and how refunds are processed.`,bodyHtml:`
<p><strong>Effective ${B}.</strong> This policy forms part of our <a href="/pages/terms">Terms of service</a>. Nothing in it removes your statutory rights under the Federal Competition and Consumer Protection Act 2018.</p>

<h2>Start every return with us first</h2>
<p>Contact us ${c} <strong>before</strong> sending anything back, quoting your order number. We will confirm whether the item is returnable and give you a return address and a reference.</p>
...
<p>Refunds are made in the currency in which you were charged. Where you paid in a currency other than ${e}, the amount you receive may differ slightly from the amount you paid because of exchange-rate movement between the two dates. That difference is applied by your provider and is outside our control.</p>
...
`.trim()},{handle:"shipping",title:"Shipping & delivery",seoTitle:`Shipping & delivery — ${d}`,seoDescription:`Dispatch times, delivery estimates, charges, tracking and customs information for ${d} orders.`,bodyHtml:`
<p><strong>Effective ${B}.</strong> This policy forms part of our <a href="/pages/terms">Terms of service</a>.</p>

<h2>What delivery costs</h2>
<p>${D(a)} The exact charge for your order is shown at checkout before you pay.</p>

<h2>Dispatch and delivery times</h2>
<p>Orders are prepared for dispatch within <strong>${z.vM}</strong>. Delivery then typically takes <strong>${z.Nq}</strong>, depending on the item and on your location. Business days exclude weekends and public holidays.</p>
